...
void LCD_vinit ()
{
	...
	DIO_vset_pin_dir('B',4,1);                        //pin 4 on port A is output
	DIO_vset_pin_dir('B',5,1);                       //pin 5 on port A is output
	DIO_vset_pin_dir('B',6,1);                      //pin 6 on port A is output
	DIO_vset_pin_dir('B',7,1);                     //pin 7 on port A is output
	DIO_vset_pin_dir('B',EN,1);                   //pin 0 on port B is output
	DIO_vset_pin_dir('B',RW,1);                  //pin 1 on port B is output
	DIO_vset_pin_dir('B',RS,1);                 //pin 2 on port B is output
	DIO_vwrite_pin('B',RW,0);                  // RW=0 to send commands
